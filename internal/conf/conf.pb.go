...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	,
	...
	0x0a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xdd, 0x03, 0x0a,
	0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x40, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
	...
	0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server)(nil),              // 1: example.internal.conf.Server
	(*Data)(nil),                // 2: example.internal.conf.Data
	(*Trace)(nil),               // 3: example.internal.conf.Trace
	(*Server_HTTP)(nil),         // 4: example.internal.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 5: example.internal.conf.Server.GRPC
	(*Data_Database)(nil),       // 6: example.internal.conf.Data.Database
	(*Data_Redis)(nil),          // 7: example.internal.conf.Data.Redis
	(*durationpb.Duration)(nil), // 8: google.protobuf.Duration
}
var file_internal_conf_conf_proto_depIdxs = []int32{
	3,  // 0: example.internal.conf.Bootstrap.trace:type_name -> example.internal.conf.Trace
	1,  // 1: example.internal.conf.Bootstrap.server:type_name -> example.internal.conf.Server
	2,  // 2: example.internal.conf.Bootstrap.data:type_name -> example.internal.conf.Data
	4,  // 3: example.internal.conf.Server.http:type_name -> example.internal.conf.Server.HTTP
	5,  // 4: example.internal.conf.Server.grpc:type_name -> example.internal.conf.Server.GRPC
	6,  // 5: example.internal.conf.Data.database:type_name -> example.internal.conf.Data.Database
	7,  // 6: example.internal.conf.Data.redis:type_name -> example.internal.conf.Data.Redis
	8,  // 7: example.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	8,  // 8: example.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	8,  // 9: example.internal.conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	8,  // 10: example.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	8,  // 11: example.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
